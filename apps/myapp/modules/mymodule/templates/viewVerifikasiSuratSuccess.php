...
<html>
	<head>
	  <?php echo use_javascript('oasys_js/action_internal.js') ?>
	...
	<body onload="initDynamicOptionLists();">
      ...
      <form name="verifikasiSurat" method="post" enctype="multipart/form-data">
		<table>
		  <tr>
		  ...
		  <tr>
			<td></td>
			<td></td>
		    <td><input type="button" name="kembalikan" value="Kembalikan" onclick="Kembali();" /><input type="button" name="teruskan" value="Teruskan" onclick="Terus();" /></td>
		  </tr>
		</table>
		  <div id="pdf">
