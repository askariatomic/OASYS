...
<html>
	<head>
	  <?php echo javascript_include_tag('DynamicOptionList') ?>
	  ...
	  <?php echo form_tag('mymodule/insDisposisiSurat', 'multipart=true') ?>  
		<table>
		  ...
		  <tr>
	        ...
	        <td>:</td>
	        <td><?php echo input_tag('dari', $_SESSION['dari'], 'size=50') ?></td>
	      </tr>
	      <tr>
	        <td><label for="tanggal_masuk">Tanggal Masuk</label></td>
	        <td>:</td>
	        <td><?php echo input_tag('tanggal_masuk', $_SESSION['tanggal_masuk'], 'size=50') ?></td>
	      </tr>
	      <tr>
	        <td><label for="tanggal_surat">Tanggal Surat</label></td>
	        <td>:</td>
	        <td><?php echo input_tag('tanggal_surat', $_SESSION['tanggal_surat'], 'size=50') ?></td>
	      </tr>
	      <tr>
	        <td><label for="sifat_surat">Sifat Surat</label></td>
	        <td>:</td>
	        <td><?php echo input_tag('sifat_surat', $_SESSION['sifat_surat'], 'size=50') ?></td>
	      </tr>
	      <tr>
	        <td><label for="nomor_surat">Nomor Surat</label></td>
	        <td>:</td>
	        <td><?php echo input_tag('nomor_surat', $_SESSION['nomor_surat'], 'size=50') ?></td>
	      </tr>
	      <tr>
	      ...
	      <tr>
	        ...
	        <td valign="top">:</td>
	        <td><?php echo $_SESSION['pesan']; ?></td>
	      </tr>
	      <tr>
	        <td valign="top"><label for="komentar">Komentar</label></td>
	        <td valign="top">:</td>
	        <td> <textarea id="pesan" name="komentar" style="width:100%"></textarea></td>
	      </tr>
	      <tr>
