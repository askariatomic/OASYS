...
$query = "SELECT KD_DISPOSISI, NOMOR_SURAT, PERIHAL, TANGGAL FROM `oasys_disposisi` WHERE NIP = '".$_SESSION['nip']."' ORDER BY TANGGAL DESC";
...
<html>
	...
	<body>
	  <h3>Daftar Terkirim Disposisi</h3>
	  ...
	  <?php foreach ($data as $a){ ?>
	    <tr>
		  ...
		  <td><a target="_blank" href="viewTerkirimDisposisiSurat?kd_disposisi=<?php echo $data->getString('KD_DISPOSISI') ?>">Lihat</a></td> 
	    </tr>
	  <?php } ?>
	   </tbody>
	  </table>
