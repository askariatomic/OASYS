...
$query = "SELECT KD_SURAT, NIP, NOMOR_SURAT, PERIHAL, TANGGAL FROM `oasys_konsep_surat_internal` WHERE NIP = '".$_SESSION['nip']."' ORDER BY TANGGAL DESC";
...
<html>
	...
	<body>
	  <h3>Daftar Konsep Surat Internal</h3>
	  ...
	  <?php foreach ($data as $a){ ?>
	    <tr>
		  ...
		  <td><a href="viewKonsepSuratKeluarInternal?kd_surat=<?php echo $data->getString('KD_SURAT') ?>">Lihat</a></td>		  
	    </tr>
	  <?php } ?>
	   </tbody>
	  </table>
